### TCGA PAAD Correlation Analysis: Expanded Immune Marker List (from Merged_Immune_Pathway_Markers_in_Glioma.docx)
...
# Step 7: Save heatmap
out_path <- file.path(out_dir, "Spearman_Correlation_Heatmap_PAAD_All_Immune.png")
...
pheatmap(cor_block,
         ...
         fontsize = 10,
         main = "Spearman Correlation: Pathway vs Full Immune Marker Set (TCGA-PAAD)")
dev.off()

# Step 8: Print summary statistics
cat("Analysis Summary (TCGA-PAAD):\n")
cat("=============================\n")
...
cor_csv_path <- file.path(out_dir, "Spearman_Correlation_Matrix_PAAD_All_Immune.csv")
